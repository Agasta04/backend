...
app.get("/laporan-nilai/:id_santri", (req, res) => {
...
app.get("/dashboard-ustadz/:id_ustadz", (req, res) => {
...
app.get("/dashboard-ustadz/:id_ustadz/recent-hafalan", (req, res) => {
...
app.get("/hafalan-santri", (req, res) => {
...
app.put("/update-hafalan/:id", (req, res) => {
  const { id } = req.params;
...
// ✅ Hapus Hafalan
app.delete("/delete-hafalan/:id", (req, res) => {
  const { id } = req.params;
...
app.get("/class-ustadz", async (req, res) => {
  try {
...
app.put("/reset-password-santri/:id", async (req, res) => {
  const { id } = req.params;
...
// ✅ Delete data santri
app.delete("/delete-santri/:id", (req, res) => {
  const { id } = req.params;
...
// ✅ Delete data ustadz
app.delete("/delete-ustadz/:id", (req, res) => {
  const { id } = req.params;
